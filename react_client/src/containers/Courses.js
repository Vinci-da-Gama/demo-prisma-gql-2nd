...
import { CommonArgs } from '../constants/commonArgs';
...
const Courses = (props) => {
    ...
    const setPaginationOrder = () => {
        return {
            ...
            orderBy: 'name_DESC' // check this in schema.graphql
        }
    }
            ...
            >
                {({ data, loading, error }) => {
                    ...
                    const updateAfterDelete = (cache, { data: { deleteCourse } }) => {
                        ...
                        console.log('46 -- courses: ', courses)
                        console.log('47 -- deleteCourse: ', deleteCourse)
                        cache.writeQuery({
                            query: GET_COURSES_WITH_PAGINATION_AND_FILTER,
                            data: {
                                courses: {
